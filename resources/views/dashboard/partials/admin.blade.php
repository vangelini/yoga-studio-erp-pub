                                                    ...
                                                    <td class="px-4 py-3">
                                                        <div class="flex flex-row flex-wrap items-center gap-2" x-data="{ showWaiveForm: false }">
                                                            <form
                                                                ...
                                                                onsubmit="return confirm('Confermi di registrare il pagamento per {{ $entry['client_name'] ?? 'questa allieva-o' }}?');"
                                                            >
                                                                @csrf
                                                                <label class="sr-only" for="course-payment-method-{{ $entry['payment_id'] }}">Metodo</label>
                                                                <select
                                                                    id="course-payment-method-{{ $entry['payment_id'] }}"
                                                                    name="action"
