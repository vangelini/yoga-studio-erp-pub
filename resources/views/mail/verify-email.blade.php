            ...
            <table width="600" cellspacing="0" cellpadding="0" style="background-color:#ffffff;border-radius:24px;padding:40px;border:1px solid #e5e7eb;">
                ...
                <tr>
                    <td align="center" style="padding-bottom:32px;">
                        <a href="{{ $url }}" style="display:inline-block;padding:14px 28px;background:linear-gradient(135deg,#0d9488,#14b8a6);color:#ffffff;text-decoration:none;border-radius:999px;font-weight:600;font-size:14px;">Conferma indirizzo email</a>
                    </td>
                </tr>
                <tr>
