...
>
    ...
    <div class="card p-6 space-y-6">
        ...
        @unless($private_lessons_enabled)
                ...
                <tbody class="divide-y divide-stone-100">
                    @forelse ($teacherAdminList as $teacher)
                        ...
                        <tr class="hover:bg-stone-50">
                            ...
                            <td class="px-4 py-3">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach ($permBadges as $perm)
                                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-[11px] font-semibold {{ $perm['enabled'] ? 'bg-emerald-100 text-emerald-700' : 'bg-stone-100 text-stone-500' }}">
                                            {{ $perm['label'] }}
                                        </span>
                                    @endforeach
                                </div>
                        ...
                        <tr x-show="expandedTeacher === {{ $teacher->id }}" x-cloak x-transition>
                            <td colspan="{{ $private_lessons_enabled ? 7 : 6 }}" class="px-4 pb-5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-2">
                                                            <label class="inline-flex items-center gap-2 rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-600">
                                                                ...
                                                                <input type="checkbox" name="teacher_can_manage_courses" value="1" @checked($teacher->can_manage_courses) class="h-4 w-4 text-teal-600 border-stone-300 rounded">
                                                                <span>Gestione corsi assegnati</span>
                                                            </label>
                                                            <label class="inline-flex items-center gap-2 rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-600">
                                                                <input type="hidden" name="teacher_can_manage_payments" value="0">
                                                                <input type="checkbox" name="teacher_can_manage_payments" value="1" @checked($teacher->can_manage_payments) class="h-4 w-4 text-teal-600 border-stone-300 rounded">
                                                                <span>Gestione pagamenti</span>
                                                            </label>
                                                            <label class="inline-flex items-center gap-2 rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-600">
                                                                <input type="hidden" name="teacher_can_manage_students" value="0">
                                                                <input type="checkbox" name="teacher_can_manage_students" value="1" @checked($teacher->can_manage_students) class="h-4 w-4 text-teal-600 border-stone-300 rounded">
                                                                <span>Gestione allievi</span>
                                                            </label>
                                                        </div>
                                                    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ $private_lessons_enabled ? 7 : 6 }}" class="px-4 py-6 text-center text-stone-500">Nessun insegnante registrato al momento.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
