        ...
        <div class="bg-white shadow-xl border border-stone-200/70 rounded-2xl p-6 space-y-6">
            <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email', $email)); ?>" required autofocus class="input-field mt-1">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center text-sm">
            <a href="<?php echo e(route('login')); ?>" class="text-teal-600 font-semibold hover:text-teal-700">Torna al login</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vincenzo/Documents/yoga-studio-erp/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>