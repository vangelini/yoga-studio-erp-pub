        ...
        <div class="max-w-2xl mx-auto card p-10 space-y-6 text-center">
            <div class="flex flex-col items-center gap-4">
                ...
                <?php if(session('status')): ?>
                    <p class="text-sm text-emerald-600 font-semibold"><?php echo e(session('status')); ?></p>
                <?php else: ?>
                    <p class="text-sm text-stone-600 leading-relaxed">
                        Ti abbiamo inviato un link di verifica all'indirizzo <strong><?php echo e(auth()->user()->email); ?></strong>.<br>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vincenzo/Documents/shanti-sadhana-yoga-center/php-laravel/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>