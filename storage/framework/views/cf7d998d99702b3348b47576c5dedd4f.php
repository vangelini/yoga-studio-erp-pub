                        ...
                        <div class="space-y-2">
                            ...
                            <?php if(!empty($course['start_date_human']) || !empty($course['end_date_human'])): ?>
                                <p class="text-xs text-teal-700 font-semibold bg-teal-50 border border-teal-200 inline-flex items-center gap-2 px-3 py-1 rounded-full">
                                    ...
                                    <span>Periodo: <?php echo e($course['start_date_human'] ?? '—'); ?> → <?php echo e($course['end_date_human'] ?? '—'); ?></span>
                                </p>
                            <?php endif; ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                        <div>
                                            ...
                                            <input type="number" step="0.01" name="monthly_price" value="<?php echo e(number_format($course['monthly_price'] ?? $course['price'] ?? 0, 2, '.', '')); ?>" class="w-full p-2.5 rounded-lg border border-stone-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                        </div>
                                        <div>
                                            <span class="text-[11px] font-semibold uppercase text-stone-400">Trimestrale</span>
                                            <input type="number" step="0.01" name="quarterly_price" value="<?php echo e(number_format($course['quarterly_price'] ?? 0, 2, '.', '')); ?>" class="w-full p-2.5 rounded-lg border border-stone-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                        </div>
                                        <div>
                                            <span class="text-[11px] font-semibold uppercase text-stone-400">Annuale</span>
                                            <input type="number" step="0.01" name="annual_price" value="<?php echo e(number_format($course['annual_price'] ?? 0, 2, '.', '')); ?>" class="w-full p-2.5 rounded-lg border border-stone-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                        </div>
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    <label class="text-xs font-semibold uppercase text-stone-500">Data inizio</label>
                                    <input type="date" name="start_date" value="<?php echo e($course['start_date'] ?? ''); ?>" required class="w-full p-2.5 rounded-lg border border-stone-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-xs font-semibold uppercase text-stone-500">Data fine</label>
                                    <input type="date" name="end_date" value="<?php echo e($course['end_date'] ?? ''); ?>" required class="w-full p-2.5 rounded-lg border border-stone-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                </div>
                                <div class="space-y-2">
