            ...
            <table width="600" cellspacing="0" cellpadding="0" style="background-color:#ffffff;border-radius:24px;padding:40px;border:1px solid #e5e7eb;">
                ...
                <tr>
                    <td style="font-size:15px;line-height:1.6;padding-bottom:24px;">
                        ...
                        <p style="margin:0;">Il link resterà valido per <strong><?php echo e($expireMinutes); ?> minuti</strong>. Se non hai richiesto tu questa operazione puoi ignorare questa email: nessuna modifica verrà applicata.</p>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding-bottom:32px;">
                        <a href="<?php echo e($url); ?>" style="display:inline-block;padding:14px 28px;background:linear-gradient(135deg,#0d9488,#14b8a6);color:#ffffff;text-decoration:none;border-radius:999px;font-weight:600;font-size:14px;">Imposta nuova password</a>
                    </td>
                </tr>
                <tr>
...
<?php /**PATH /Users/vincenzo/Documents/yoga-studio-erp/resources/views/mail/password-reset.blade.php ENDPATH**/ ?>